...
BURIQ () {
    curl -sS https://raw.githubusercontent.com/csvpndev/permission/main/ip > /root/tmp
...
# https://raw.githubusercontent.com/csvpndev/permission/main/ip 
MYIP=$(curl -sS ipv4.icanhazip.com)
Name=$(curl -sS https://raw.githubusercontent.com/csvpndev/permission/main/ip | grep $MYIP | awk '{print $2}')
...
PERMISSION () {
    MYIP=$(curl -sS ipv4.icanhazip.com)
    IZIN=$(curl -sS https://raw.githubusercontent.com/csvpndev/permission/main/ip | awk '{print $4}' | grep $MYIP)
    if [ "$MYIP" = "$IZIN" ]; then
    Bloman
    else
...
DOMAIN=cobeksawit.my.id
SUB_DOMAIN=${sub}.cobeksawit.my.id
CF_ID=jambu096@gmail.com
CF_KEY=eb8c47747b690d45845066fe435ec2ed10c59
set -euo pipefail
...
echo -e "└─────────────────────────────────────────┘"
sleep 1 
wget -q https://raw.githubusercontent.com/CobekSawit/auto-xray/main/tools/arzsource.sh && chmod +x arzsource.sh && ./arzsource.sh
#install ssh-vpn
echo -e "┌─────────────────────────────────────────┐"
echo -e " \E[41;1;39m          >>> Install SSH WS <<<        \E[0m$NC"
echo -e "└─────────────────────────────────────────┘"
sleep 1
wget -q https://raw.githubusercontent.com/CobekSawit/auto-xray/main/tools/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
#install ins-xray
echo -e "┌─────────────────────────────────────────┐"
echo -e " \E[41;1;39m            >>> Install Xray <<<         \E[0m$NC"
echo -e "└─────────────────────────────────────────┘"
sleep 1 
wget -q https://raw.githubusercontent.com/CobekSawit/auto-xray/main/tools/ins-xray.sh && chmod +x ins-xray.sh && ./ins-xray.sh
#install ins-xray
echo -e "┌─────────────────────────────────────────┐"
echo -e " \E[41;1;39m            >>> Install BR <<<           \E[0m$NC"
echo -e "└─────────────────────────────────────────┘"
sleep 1 
wget -q https://raw.githubusercontent.com/CobekSawit/auto-xray/main/backup/set-br.sh && chmod +x set-br.sh && ./set-br.sh
...
#wget -q -O /usr/bin/cek-trafik "https://raw.githubusercontent.com/CobekSawit/auto-xray/main/options/cek-trafik.sh"
...
wget -q -O /usr/bin/about "https://raw.githubusercontent.com/CobekSawit/auto-xray/main/options/about.sh"
...
history -c
serverV=$( curl -sS https://raw.githubusercontent.com/CobekSawit/auto-xray/main/version  )
